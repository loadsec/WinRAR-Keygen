      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 w-full max-w-md shadow-xl">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              <option value="Single PC" className="bg-gray-800 text-white">
                Single PC
              </option>
              <option value="Local Site" className="bg-gray-800 text-white">
                Local Site
              </option>
              <option
              ...
              <option value="1000 PC" className="bg-gray-800 text-white">
                1000 PC
              </option>
            </select>
          </div>
